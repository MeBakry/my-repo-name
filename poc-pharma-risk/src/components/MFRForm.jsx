...
export default function MFRForm({ onSubmit, authStatus, initialData }) {
  ...
  function handleSubmit(e) {
    ...
    if (validate()) {
      ...
      // Combine concentrationValue + concentrationUnit into a single string for the rule engine
          ...
          <div className="duplicate-warning">
            ...
            <div className="duplicate-warning-content">
              ...
              <span className="duplicate-hint">
                You can still generate a new assessment — it will be saved as a new version.
              </span>
            </div>
            <button
              type="button"
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="e.g. NS-001 (optional)"
