...
import { parseConcentration, buildFormDataFromMfr } from "../utils/mfrFormData";

// Re-export for any code that still imports from Dashboard
export { parseConcentration, buildFormDataFromMfr };
...
// Map backend MFR ingredient to form ingredient format (uses buildFormDataFromMfr internally via util)
